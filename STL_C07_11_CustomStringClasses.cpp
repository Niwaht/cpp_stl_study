...
public:
    static constexpr void assign(char_type& r, const char_type& a) { r = tolow(a); }
...
public:
    static constexpr bool eq(char_type a, char_type b) { return tolow(a) == tolow(b); }
    static constexpr bool lt(char_type a, char_type b) { return tolow(a) <  tolow(b); }
...
int main()
{
    ...
    if(user_input == password) {
        cout << "Passwords match: \"" << user_input << "\" == \"" << password << "\"\n";
    }
