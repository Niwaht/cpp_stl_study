...
public:
    cat(string n) : name{n} {}
    void meow() const { cout << name << " says Meow!\n"; }
};
...
public:
    dog(string n) : name{n} {}
    void woof() const { cout << name << " says Woof!\n"; }
};
...
int main()
{
    ...
    cout << "There are "
         << count_if(begin(l), end(l), is_type<cat>) << " cats and "
         << count_if(begin(l), end(l), is_type<dog>) << " dogs in the list.\n";
