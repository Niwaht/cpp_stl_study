...
// 6. A deque holding just one element has to allocate its full internal array (e.g. 8 time the object size on
//    64-bit libstdc++; 16 times the object size for 4096 bytes, whichever is larger, on 64-bit libc++).
